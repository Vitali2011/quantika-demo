...
6. **F5+F6+F7** — auth model gap (`session_id` required for /charterers, /processing API). F5+F6 closed via PR #254, **F7 (/processing 403 CSRF) closed via PR #322 (2026-05-22)**.
