...
**Generated:** 2026-05-06T09:24:27.057Z

## Per-endpoint winners
| Endpoint | Winner | Cost/1k | Parity+Better | Flags | Rationale |
| --- | --- | --- | --- | --- | --- |
| classify | gemini-2.5-flash-lite | $0.4532 | 48.1% | practical-gate | Cheapest qualifying model. passRate=96.3% (practical gate 80%, 0 crit), cost/1k=$0.4532, p50 latency=1615ms. |
| parse-cargo | gemini-2.5-flash | $3.3878 | 41.7% | practical-gate, single-passing | Cheapest qualifying model. passRate=87.5% (practical gate 80%, 0 crit), cost/1k=$3.3878, p50 latency=20151ms. |
| parse-recap | gemini-2.5-flash-lite | $0.9186 | 0.0% | practical-gate | Cheapest qualifying model. passRate=90.9% (practical gate 80%, 0 crit), cost/1k=$0.9186, p50 latency=4389ms. |
...
# parse-cargo: gemini-2.5-flash
PARSE_CARGO_PROVIDER=gemini
PARSE_CARGO_MODEL=gemini-2.5-flash
# parse-recap: gemini-2.5-flash-lite
PARSE_RECAP_PROVIDER=gemini
PARSE_RECAP_MODEL=gemini-2.5-flash-lite
