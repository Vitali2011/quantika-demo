...
const vesselItemSchema = {
  ...
  properties: {
    ...
    hold_count: { type: Type.NUMBER, nullable: true },
    hatch_count: { type: Type.NUMBER, nullable: true },
    geared: { type: Type.BOOLEAN, nullable: true },
    gear_description: { type: Type.STRING, nullable: true },
    open_port: confidenceFieldString,
    ...
    p_and_i_club: { type: Type.STRING, nullable: true },
