...
function makeCargo(overrides: Partial<ParsedCargo> = {}): ParsedCargo {
  return {
    ...
    itemIndex: 0,
    originPort: { value: 'Iskenderun', confidence: 0.95 },
    originCountry: { value: 'Turkey', confidence: 0.9 },
    destinationPort: { value: 'Rotterdam', confidence: 0.9 },
    destinationCountry: { value: 'Netherlands', confidence: 0.9 },
    cargoDescription: { value: 'wheat in bulk', confidence: 0.9 },
    weightMt: { value: 30000, confidence: 0.9 },
    weightMtMin: 28000,
    weightMtMax: 32000,
    volumeCbm: null,
    dimensions: null,
...
function makeVessel(overrides: Partial<ParsedVessel> = {}): ParsedVessel {
  return {
    ...
    classSociety: null,
    pandi: null,
    dwtSummer: { value: 35000, confidence: 0.95 },
    dwcc: { value: 33000, confidence: 0.9 },
    draftMax: { value: 11.5, confidence: 0.9 },
    loa: 180,
    beam: null,
    grt: null,
    nrt: null,
    ...
    hatchType: null,
    vesselType: 'BULK',
    openPosition: { value: 'Piraeus', confidence: 0.9 },
    openDate: { value: '10 May 2026', confidence: 0.9 },
    direction: null,
    restrictions: [],
    lastCargoes: null,
    speedLaden: 13,
